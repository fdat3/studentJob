...
interface PopularServiceSlideCard2Props {
  data: ProductInterface;
}
export default function PopularServiceSlideCard2({
  data,
}: PopularServiceSlideCard2Props) {
              ...
              >
                ...
                <div className="swiper__parent">
                  <div className="row justify-content-center">
                    ...
                    <div className="col-auto">
                      <div className="swiper__pagination swiper__pagination-2 swiper__pagination__018" />
                    </div>
                    <div className="col-auto">
