...
export default function ProjectCard2({ data }: ProjectCard2Props) {
  return (
    <>
        ...
        <div className="d-flex align-items-center">
          ...
          <div>
            <span className="mb-0 fz14 dark-color list-inline-item mb5-sm">
              <i className="flaticon-place fz12 me-1" /> {data.location}
            </span>
            <span className="mb-0 fz14 dark-color list-inline-item mb5-sm">
              <i className="flaticon-30-days fz12 me-1" /> 2 hours ago
            </span>
            <span className="mb-0 fz14 dark-color list-inline-item mb5-sm">
              <i className="flaticon-contract fz12 me-1" /> 1 Received
            </span>
          </div>
        </div>
