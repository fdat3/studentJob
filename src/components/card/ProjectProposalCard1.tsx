...
import type { ProjectProposalInterface } from '@/interface/project.interface';

interface ProjectProposalCard1Props {
  data: ProjectProposalInterface;
}
export default function ProjectProposalCard1({
  data,
}: ProjectProposalCard1Props) {
  return (
    <>
