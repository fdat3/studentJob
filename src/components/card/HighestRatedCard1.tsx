...
interface HighestRatedCard1Props {
  data: FreelancerInterface;
  btnClass?: string;
}

export default function HighestRatedCard1({
  data,
  btnClass,
}: HighestRatedCard1Props) {
  return (
    <>
        ...
        <div className="details">
          ...
          <div className="review">
            <p>
              ...
              <span className="dark-color">{data.rating}</span> ({data.reviews}{' '}
              reviews)
            </p>
          </div>
          ...
          <div className="d-grid mt15">
            <Link
              ...
              className={btnClass || 'ud-btn btn-light-thm bdrs90'}
            >
              View Profile
