...
import type { BlogInterface } from '@/interface/blog.interface';

interface BlogCardRecentCard1Props {
  data: BlogInterface;
  index: {
    firstIndex: number;
    lastIndex: number;
...
export default function BlogRecentCard1({
  data,
  index,
}: BlogCardRecentCard1Props) {
  return (
    <>
      <div
