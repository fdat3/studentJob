...
import type { LearnInterface } from '@/interface/learn.interface';

interface LearnFreeioCardProps {
  data: LearnInterface;
}
export default function LearnFreeioCard({ data }: LearnFreeioCardProps) {
  return (
    <>
