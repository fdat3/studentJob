import { handleDelAward, handleGetAwardById } from "@/service/award.service";
import { handleDeleteEdu, handleGetEduById } from "@/service/education.service";
import { handleDelExp, handleGetExpById } from "@/service/experience.service";
import { useState } from "react";

export default function DeleteAwardModal(props: any) {
    ...
    const handleClick = async () => {
        const updatedEdu: any = await handleDelAward(props?.id);
        return updatedEdu
    };
    return (
        <>
