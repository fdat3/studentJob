...
import type { ManageServiceInterface } from '@/interface/service.interface';

interface ManageServiceCard1Props {
  data: ManageServiceInterface;
}
export default function ManageServiceCard1({ data }: ManageServiceCard1Props) {
  return (
    <>
      <tr>
