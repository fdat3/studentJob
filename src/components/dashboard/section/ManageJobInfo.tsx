                                        ...
                                        {user?.role === 1 ?
                                                        ...
                                                        < tr key={data.id}>
                                                            ...
                                                            <td className="vam">
                                                                {data?.deleted_at == null || undefined
                                                                    ...
                                                                    : <span
                                                                        className="pending-style style6">Expired</span>
                                                                }
                                                            </td>
                                                            <td>
                                            ...
                                            : <>{props?.length == 0 ?
                                                <tr style={{textAlign: 'center', verticalAlign: 'middle'}}>
                                                    <td colSpan={5}>You've not applied any job</td>
                                                </tr>
                                                : props?.map((applied: any) => {
                                                    return (
                                                        < tr key={applied.id}>
                                                            ...
                                                            <td className="vam">
                                                                {applied?.status == 0 && <span
                                                                    className="pending-style style1">WAITING</span>}
                                                                {applied?.status == 1 && <span
                                                                    className="pending-style style6">ACCEPT</span>}
                                                                {applied?.status == 6 &&
                                                                    <span className="pending-style style4" style={{
                                                                        padding: "10px 25px"
                                                                    }}>FINISH</span>}
                                                            </td>
                                                            <td>
