...
export default function ManageJobInfo() {
  ...
  const fetchJobByOwner = () =>
    handleGetJobByOwnerId(user?.id)
      .then((res: any) => {
        setAdminJobs(res);
      })
      .catch((error: any) => {
                              ...
                              <tr key={data.id}>
                                ...
                                <td className="vam">
                                  {data?.deleted_at == null || undefined ? (
                                    <span className="pending-style style6">
                                      Active
                                    </span>
                                  ) : (
                                    <span className="pending-style style6">
                            ...
                            props?.map((applied: any) => {
                              return (
                                <tr key={applied.id}>
                                  ...
                                  <td className="vam">
                                    <span className="fz15 fw400">
                                      {applied?.proposal_count}+ Applied
                                    </span>
                                  </td>
                                  <td className="vam">
                                    <span>{formatDate}</span>
