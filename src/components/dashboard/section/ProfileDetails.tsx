                    ...
                    <div className="profile-box d-sm-flex align-items-center mb30">
                        ...
                        <div className="profile-content ml20 ml0-xs">
                            ...
                            <p className="text mb-0">
                                Kích thước tệp tối đa: 1MB, Kích thước tối thiểu: 330x300, hỗ trợ định dạng tệp phù hợp
                                là .jpg &amp; .png
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6">
                                <div className="mb20">
                                    ...
                                    <Select
                                        defaultValue={{
                                            label: profile && profile.major ? StudentMajor[profile.major] : '',
                                            value: profile?.major,
                                        }}
                                        options={
                            ...
                            <div className="col-sm-6">
                                <div className="mb20">
                                    ...
                                    <Select
                                        defaultValue={{
                                            label: profile && profile.gender ? Gender[profile.gender] : '',
                            ...
                            <div className="col-sm-6">
                                <div className="mb20">
                                    ...
                                    <Select
                                        defaultValue={{
                                            label: profile && profile.city ? City[profile.city] : '',
                                            value: profile?.city,
                                        }}
                                        options={
